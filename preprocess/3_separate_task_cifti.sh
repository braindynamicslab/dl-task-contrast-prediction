...
do
    ...
    do
        ...
        do
            ...
            CIFTI_FILE=$SUBJ_DIR/MNINonLinear/Results/tfMRI_$TASK/tfMRI_${TASK}_hp200_s4_level2_MSMAll.feat/GrayordinatesStats/cope${COPEID}.feat/zstat1.dtseries.nii
            ...
            if [ -f "$CIFTI_FILE" ] && [ ! -f "$LH_NIFTI_FILE" ]; then
                $WB_COMMAND -cifti-separate  $CIFTI_FILE COLUMN -metric CORTEX_LEFT $LH_NIFTI_FILE -metric CORTEX_RIGHT $RH_NIFTI_FILE
            fi
        done
    done
done < $SUBJLIST
