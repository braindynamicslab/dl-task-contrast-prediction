...
from model.brain_surf_cnn import BrainSErfCNN
...
if __name__ == "__main__":
    ...
    if args.loss == 'rc':
        ...
        print("Initial Parameters: within-subj margin %.1f - across-subj margin %.1f" % (init_within_subj_margin, init_across_subj_margin))
